...
function renderClubs() {
  ...
  const it3a = sortClubs(state.clubs.filter(c => c.league_id === "IT3A"));
...
function openPlayerModal(pid) {
  ...
  const compColor = (code, isNational) => {
    ...
    if (code === "IT3A" || code === "IT3B" || code === "IT3C") return "var(--comp-it3)";
...
function applyCallupFilters(players) {
  ...
  return players.filter(p => {
    ...
    if (f.league) {
      ...
      const isKnownLeague = (lg === "IT1" || lg === "IT2" || lg === "IT3A" || lg === "IT3B" || lg === "IT3C" || lg === "IJ1" || lg === "PL1" || lg === "PL2");
      ...
      <div class="rounded-xl p-4" style="background: var(--surface); border: 0.5px solid var(--border);">
        ...
        <div class="flex flex-wrap gap-2 mb-3">
          ...
          <select id="callup-league" class="filter-select" style="font-size: 12px;">
            ...
            <option value="IT3A" ${f.league==="IT3A"?"selected":""}>${t("league_it3a")}</option>
...
// 2026-06-08: ORDINE FORMATIONS canonico — difese a 4 prima, poi a 3.
// Stesso ordine usato in PitchPlan (FORMATIONS select tattica) per
// consistenza UX cross-app:
//   4-4-2 → 4-3-3 → 4-2-3-1 → 4-3-1-2 → 4-3-2-1 → 3-5-2 → 3-4-3 → 3-4-2-1 → 3-4-1-2
const FORMATIONS = {
  "4-4-2": [
    { id: "GK",  x: 50, y: 4,  label: "GK" },
    { id: "RB", x: 88, y: 44, label: "RB" },
    { id: "RCB", x: 62, y: 38, label: "CB" },
    { id: "LCB", x: 38, y: 38, label: "CB" },
    { id: "LB", x: 12, y: 44, label: "LB" },
    { id: "RM",  x: 86, y: 65, label: "RM" },
    { id: "RCM", x: 62, y: 63, label: "CM" },
    { id: "LCM", x: 38, y: 63, label: "CM" },
    { id: "LM",  x: 14, y: 65, label: "LM" },
    { id: "RST", x: 66, y: 92, label: "ST" },
    { id: "LST", x: 34, y: 92, label: "ST" },
  ],
  "4-3-3": [
    { id: "GK",  x: 50, y: 4,  label: "GK"  },
    { id: "RB", x: 88, y: 44, label: "RB"  },
    ...
    { id: "LCB", x: 38, y: 38, label: "CB"  },
    { id: "LB", x: 12, y: 44, label: "LB"  },
    { id: "RCM", x: 82, y: 65, label: "CM"  },
    { id: "CM",  x: 50, y: 59, label: "CM"  },
    { id: "LCM", x: 18, y: 65, label: "CM"  },
    { id: "RW",  x: 86, y: 86, label: "RW"  },
    { id: "ST",  x: 50, y: 94, label: "ST"  },
    { id: "LW",  x: 14, y: 86, label: "LW"  },
  ],
  "4-2-3-1": [
    { id: "GK",  x: 50, y: 4,  label: "GK"   },
    { id: "RB", x: 88, y: 44, label: "RB"   },
    ...
    { id: "LCB", x: 38, y: 38, label: "CB"   },
    { id: "LB", x: 12, y: 44, label: "LB"   },
    { id: "RDM", x: 66, y: 55, label: "DM"   },
    { id: "LDM", x: 34, y: 55, label: "DM"   },
    { id: "RAM", x: 90, y: 75, label: "RAM"  },
    { id: "CAM", x: 50, y: 74, label: "CAM"  },
    { id: "LAM", x: 10, y: 75, label: "LAM"  },
    { id: "ST",  x: 50, y: 95, label: "ST"   },
  ],
  "4-3-1-2": [
    { id: "GK",  x: 50, y: 4,  label: "GK"  },
    { id: "RB",  x: 88, y: 44, label: "RB"  },
    ...
    { id: "LCB", x: 38, y: 38, label: "CB"  },
    { id: "LB",  x: 12, y: 44, label: "LB"  },
    { id: "RCM", x: 76, y: 63, label: "CM"  },
    { id: "DM",  x: 50, y: 57, label: "DM"  },
    { id: "LCM", x: 24, y: 63, label: "CM"  },
    { id: "CAM", x: 50, y: 78, label: "CAM" },
    { id: "RST", x: 64, y: 94, label: "ST"  },
    { id: "LST", x: 36, y: 94, label: "ST"  },
  ],
  "4-3-2-1": [
    { id: "GK",  x: 50, y: 4,  label: "GK"  },
    { id: "RB",  x: 88, y: 44, label: "RB"  },
    ...
    { id: "LCB", x: 38, y: 38, label: "CB"  },
    { id: "LB",  x: 12, y: 44, label: "LB"  },
    { id: "RCM", x: 72, y: 63, label: "CM"  },
    { id: "CM",  x: 50, y: 59, label: "CM"  },
    { id: "LCM", x: 28, y: 63, label: "CM"  },
    { id: "RAM", x: 66, y: 80, label: "RAM" },
    { id: "LAM", x: 34, y: 80, label: "LAM" },
    { id: "ST",  x: 50, y: 95, label: "ST"  },
  ],
  "3-5-2": [
    { id: "GK",  x: 50, y: 4,  label: "GK"  },
    { id: "RCB", x: 75, y: 38, label: "CB"  },
    { id: "CB", x: 50, y: 36, label: "CB"  },
    { id: "LCB", x: 25, y: 38, label: "CB"  },
    { id: "RWB", x: 88, y: 52, label: "RWB" },
    { id: "RCM", x: 78, y: 63, label: "CM"  },
    { id: "CM",  x: 50, y: 59, label: "CM"  },
    { id: "LCM", x: 22, y: 63, label: "CM"  },
    { id: "LWB", x: 12, y: 52, label: "LWB" },
    { id: "RST", x: 64, y: 92, label: "ST"  },
    { id: "LST", x: 36, y: 92, label: "ST"  },
  ],
  "3-4-3": [
    { id: "GK",  x: 50, y: 4,  label: "GK" },
    { id: "RCB", x: 70, y: 38, label: "CB" },
    { id: "CB", x: 50, y: 36, label: "CB" },
    { id: "LCB", x: 30, y: 38, label: "CB" },
    { id: "RM",  x: 88, y: 63, label: "RM" },
    { id: "RCM", x: 63, y: 61, label: "CM" },
    { id: "LCM", x: 37, y: 61, label: "CM" },
    { id: "LM",  x: 12, y: 63, label: "LM" },
    { id: "RW",  x: 86, y: 90, label: "RW" },
    { id: "ST",  x: 50, y: 94, label: "ST" },
    { id: "LW",  x: 14, y: 90, label: "LW" },
  ],
  "3-4-2-1": [
    { id: "GK",  x: 50, y: 4,  label: "GK"  },
    { id: "RCB", x: 75, y: 38, label: "CB"  },
    ...
    { id: "LCB", x: 25, y: 38, label: "CB"  },
    { id: "RM",  x: 88, y: 63, label: "RM"  },
    { id: "RCM", x: 68, y: 61, label: "CM"  },
    { id: "LCM", x: 32, y: 61, label: "CM"  },
    { id: "LM",  x: 12, y: 63, label: "LM"  },
    { id: "RAM", x: 78, y: 85, label: "RAM" },
    { id: "LAM", x: 22, y: 85, label: "LAM" },
    { id: "ST",  x: 50, y: 95, label: "ST"  },
  ],
  "3-4-1-2": [
    { id: "GK",  x: 50, y: 4,  label: "GK"  },
    ...
    { id: "CB",  x: 50, y: 36, label: "CB"  },
    { id: "LCB", x: 30, y: 38, label: "CB"  },
    { id: "RWB", x: 88, y: 58, label: "RWB" },
    { id: "RCM", x: 64, y: 63, label: "CM"  },
    { id: "LCM", x: 36, y: 63, label: "CM"  },
    { id: "LWB", x: 12, y: 58, label: "LWB" },
    { id: "CAM", x: 50, y: 78, label: "CAM" },
    { id: "RST", x: 64, y: 94, label: "ST"  },
    { id: "LST", x: 36, y: 94, label: "ST"  },
  ],
...
function renderGridsPanel() {
  ...
  const renderSlot = (pos) => {
    ...
    // pt77 rev224: per il GK anchor al TOP (translate Y=0) così la card
    // si estende SOTTO il label invece di centrarsi sul punto e sforare
    // verso l'alto sopra ai difensori centrali.
    const yAnchor = pos.id === "GK" ? "0" : "-50%";
    const baseStyle = `position: absolute; left: ${pos.x}%; top: ${100 - pos.y}%; transform: translate(-50%, ${yAnchor}); cursor: pointer; user-select: none;`;
    ...
    if (ids.length > 0) {
      ...
      depthHtml = `
        <div class="grid-depth-popup" style="margin-top: 4px; background: rgba(14,17,22,0.94); border: 0.5px solid rgba(255,255,255,0.10); border-radius: 5px; padding: 3px; backdrop-filter: blur(4px); min-width: 250px; max-width: 290px;">
          ${ids.map((pid, idx) => {
...
async function exportGridPDF() {
  ...
  try {
    ...
    // pt77c: ROOT CAUSE del bug "Dr gu in '02" su cognomi tipo "Drăguşin":
    // jsPDF (Helvetica base, no font WinAnsi esteso) non sa renderizzare
    // i diacritici (ă ş ț đ ł ø æ ñ è...) e li sostituisce con SPAZI →
    // "Drăguşin" diventa "Dr g  u in". Soluzione: normalizzare in ASCII
    // safe prima del rendering. Mantiene leggibilita' a costo di perdere
    // gli accenti (compromesso accettabile per un PDF tabellare).
    const normalizeName = (s) => (s || "")
      .normalize("NFD")
      .replace(/[̀-ͯ]/g, "")           // combining diacritics
      .replace(/ș|ş/g, "s").replace(/Ș|Ş/g, "S") // rumeno/turco
      .replace(/ț|ţ/g, "t").replace(/Ț|Ţ/g, "T")
      .replace(/đ/g, "d").replace(/Đ/g, "D")     // serbo/croato
      .replace(/ł/g, "l").replace(/Ł/g, "L")     // polacco
      .replace(/ø/g, "o").replace(/Ø/g, "O")     // scandinavo
      .replace(/æ/g, "ae").replace(/Æ/g, "AE");
    // Tronca a 12 char con ellissi (post-normalizzazione).
    const truncName = (s, max=12) => {
    ...
    for (const pos of positions) {
      ...
      for (let i = 0; i < ids.length; i++) {
        ...
        const clubAbbr = prettyClubName(pl.current_club_name || "").replace(/\s(SFC|FC|SC|Club|Riad)\b.*$/, "").slice(0, 10);
