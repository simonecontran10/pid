...
const FORMATIONS = {
  "4-4-2": [
    { id: "GK",  x: 50, y: 22,  label: "GK" },
    { id: "RB", x: 88, y: 52, label: "RB" },
    { id: "RCB", x: 62, y: 46, label: "CB" },
    { id: "LCB", x: 38, y: 46, label: "CB" },
    { id: "LB", x: 12, y: 52, label: "LB" },
    { id: "RM",  x: 86, y: 73, label: "RM" },
    { id: "RCM", x: 62, y: 71, label: "CM" },
    { id: "LCM", x: 38, y: 71, label: "CM" },
    { id: "LM",  x: 14, y: 73, label: "LM" },
    { id: "RST", x: 66, y: 96, label: "ST" },
    { id: "LST", x: 34, y: 96, label: "ST" },
  ],
  "4-3-3": [
    { id: "GK",  x: 50, y: 22,  label: "GK"  },
    { id: "RB", x: 88, y: 52, label: "RB"  },
    ...
    { id: "LCB", x: 38, y: 46, label: "CB"  },
    { id: "LB", x: 12, y: 52, label: "LB"  },
    { id: "RCM", x: 82, y: 73, label: "CM"  },
    { id: "CM",  x: 50, y: 67, label: "CM"  },
    { id: "LCM", x: 18, y: 73, label: "CM"  },
    { id: "RW",  x: 86, y: 94, label: "RW"  },
    { id: "ST",  x: 50, y: 96, label: "ST"  },
    { id: "LW",  x: 14, y: 94, label: "LW"  },
  ],
  "4-2-3-1": [
    { id: "GK",  x: 50, y: 22,  label: "GK"   },
    { id: "RB", x: 88, y: 52, label: "RB"   },
    ...
    { id: "LCB", x: 38, y: 46, label: "CB"   },
    { id: "LB", x: 12, y: 52, label: "LB"   },
    { id: "RDM", x: 66, y: 63, label: "DM"   },
    { id: "LDM", x: 34, y: 63, label: "DM"   },
    { id: "RAM", x: 90, y: 83, label: "RAM"  },
    { id: "CAM", x: 50, y: 82, label: "CAM"  },
    { id: "LAM", x: 10, y: 83, label: "LAM"  },
    { id: "ST",  x: 50, y: 96, label: "ST"   },
  ],
  "4-3-1-2": [
    { id: "GK",  x: 50, y: 22,  label: "GK"  },
    ...
    { id: "LCB", x: 38, y: 46, label: "CB"  },
    { id: "LB",  x: 12, y: 52, label: "LB"  },
    { id: "RCM", x: 76, y: 71, label: "CM"  },
    { id: "DM",  x: 50, y: 65, label: "DM"  },
    { id: "LCM", x: 24, y: 71, label: "CM"  },
    { id: "CAM", x: 50, y: 86, label: "CAM" },
    { id: "RST", x: 64, y: 96, label: "ST"  },
    { id: "LST", x: 36, y: 96, label: "ST"  },
  ],
  "4-3-2-1": [
    { id: "GK",  x: 50, y: 22,  label: "GK"  },
    { id: "RB",  x: 88, y: 52, label: "RB"  },
    ...
    { id: "LCB", x: 38, y: 46, label: "CB"  },
    { id: "LB",  x: 12, y: 52, label: "LB"  },
    { id: "RCM", x: 72, y: 71, label: "CM"  },
    { id: "CM",  x: 50, y: 67, label: "CM"  },
    { id: "LCM", x: 28, y: 71, label: "CM"  },
    { id: "RAM", x: 66, y: 88, label: "RAM" },
    { id: "LAM", x: 34, y: 88, label: "LAM" },
    { id: "ST",  x: 50, y: 96, label: "ST"  },
  ],
  "3-5-2": [
    { id: "GK",  x: 50, y: 22,  label: "GK"  },
    { id: "RCB", x: 75, y: 46, label: "CB"  },
    { id: "CB", x: 50, y: 44, label: "CB"  },
    { id: "LCB", x: 25, y: 46, label: "CB"  },
    { id: "RWB", x: 88, y: 60, label: "RWB" },
    { id: "RCM", x: 78, y: 71, label: "CM"  },
    { id: "CM",  x: 50, y: 67, label: "CM"  },
    { id: "LCM", x: 22, y: 71, label: "CM"  },
    { id: "LWB", x: 12, y: 60, label: "LWB" },
    { id: "RST", x: 64, y: 96, label: "ST"  },
    { id: "LST", x: 36, y: 96, label: "ST"  },
  ],
  "3-4-3": [
    { id: "GK",  x: 50, y: 22,  label: "GK" },
    { id: "RCB", x: 70, y: 46, label: "CB" },
    { id: "CB", x: 50, y: 44, label: "CB" },
    { id: "LCB", x: 30, y: 46, label: "CB" },
    { id: "RM",  x: 88, y: 71, label: "RM" },
    { id: "RCM", x: 63, y: 69, label: "CM" },
    { id: "LCM", x: 37, y: 69, label: "CM" },
    { id: "LM",  x: 12, y: 71, label: "LM" },
    { id: "RW",  x: 86, y: 96, label: "RW" },
    { id: "ST",  x: 50, y: 96, label: "ST" },
    { id: "LW",  x: 14, y: 96, label: "LW" },
  ],
  "3-4-2-1": [
    { id: "GK",  x: 50, y: 22,  label: "GK"  },
    { id: "RCB", x: 75, y: 46, label: "CB"  },
    ...
    { id: "LCB", x: 25, y: 46, label: "CB"  },
    { id: "RM",  x: 88, y: 71, label: "RM"  },
    { id: "RCM", x: 68, y: 69, label: "CM"  },
    { id: "LCM", x: 32, y: 69, label: "CM"  },
    { id: "LM",  x: 12, y: 71, label: "LM"  },
    { id: "RAM", x: 78, y: 93, label: "RAM" },
    { id: "LAM", x: 22, y: 93, label: "LAM" },
    { id: "ST",  x: 50, y: 96, label: "ST"  },
  ],
  "3-4-1-2": [
    { id: "GK",  x: 50, y: 22,  label: "GK"  },
    ...
    { id: "CB",  x: 50, y: 44, label: "CB"  },
    { id: "LCB", x: 30, y: 46, label: "CB"  },
    { id: "RWB", x: 88, y: 66, label: "RWB" },
    { id: "RCM", x: 64, y: 71, label: "CM"  },
    { id: "LCM", x: 36, y: 71, label: "CM"  },
    { id: "LWB", x: 12, y: 66, label: "LWB" },
    { id: "CAM", x: 50, y: 86, label: "CAM" },
    { id: "RST", x: 64, y: 96, label: "ST"  },
    { id: "LST", x: 36, y: 96, label: "ST"  },
  ],
