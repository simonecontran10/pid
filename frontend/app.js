...
const FORMATIONS = {
  "4-4-2": [
    ...
    { id: "RB", x: 88, y: 39, label: "RB" },
    { id: "RCB", x: 62, y: 33, label: "CB" },
    { id: "LCB", x: 38, y: 33, label: "CB" },
    { id: "LB", x: 12, y: 39, label: "LB" },
    { id: "RM",  x: 86, y: 60, label: "RM" },
    { id: "RCM", x: 62, y: 58, label: "CM" },
    { id: "LCM", x: 38, y: 58, label: "CM" },
    { id: "LM",  x: 14, y: 60, label: "LM" },
    { id: "RST", x: 66, y: 88, label: "ST" },
    { id: "LST", x: 34, y: 88, label: "ST" },
  ],
  "4-3-3": [
    { id: "GK",  x: 50, y: 4,  label: "GK"  },
    { id: "RB", x: 88, y: 39, label: "RB"  },
    ...
    { id: "LCB", x: 38, y: 33, label: "CB"  },
    { id: "LB", x: 12, y: 39, label: "LB"  },
    { id: "RCM", x: 82, y: 60, label: "CM"  },
    { id: "CM",  x: 50, y: 54, label: "CM"  },
    { id: "LCM", x: 18, y: 60, label: "CM"  },
    { id: "RW",  x: 86, y: 82, label: "RW"  },
    { id: "ST",  x: 50, y: 90, label: "ST"  },
    { id: "LW",  x: 14, y: 82, label: "LW"  },
  ],
  "4-2-3-1": [
    { id: "GK",  x: 50, y: 4,  label: "GK"   },
    { id: "RB", x: 88, y: 39, label: "RB"   },
    ...
    { id: "LCB", x: 38, y: 33, label: "CB"   },
    { id: "LB", x: 12, y: 39, label: "LB"   },
    { id: "RDM", x: 66, y: 50, label: "DM"   },
    { id: "LDM", x: 34, y: 50, label: "DM"   },
    { id: "RAM", x: 90, y: 71, label: "RAM"  },
    { id: "CAM", x: 50, y: 70, label: "CAM"  },
    { id: "LAM", x: 10, y: 71, label: "LAM"  },
    { id: "ST",  x: 50, y: 92, label: "ST"   },
  ],
  "4-3-1-2": [
    { id: "GK",  x: 50, y: 4,  label: "GK"  },
    { id: "RB",  x: 88, y: 39, label: "RB"  },
    ...
    { id: "LCB", x: 38, y: 33, label: "CB"  },
    { id: "LB",  x: 12, y: 39, label: "LB"  },
    { id: "RCM", x: 76, y: 58, label: "CM"  },
    { id: "DM",  x: 50, y: 52, label: "DM"  },
    { id: "LCM", x: 24, y: 58, label: "CM"  },
    { id: "CAM", x: 50, y: 74, label: "CAM" },
    { id: "RST", x: 64, y: 90, label: "ST"  },
    { id: "LST", x: 36, y: 90, label: "ST"  },
  ],
  "4-3-2-1": [
    { id: "GK",  x: 50, y: 4,  label: "GK"  },
    { id: "RB",  x: 88, y: 39, label: "RB"  },
    ...
    { id: "LCB", x: 38, y: 33, label: "CB"  },
    { id: "LB",  x: 12, y: 39, label: "LB"  },
    { id: "RCM", x: 72, y: 58, label: "CM"  },
    { id: "CM",  x: 50, y: 54, label: "CM"  },
    { id: "LCM", x: 28, y: 58, label: "CM"  },
    { id: "RAM", x: 66, y: 76, label: "RAM" },
    { id: "LAM", x: 34, y: 76, label: "LAM" },
    { id: "ST",  x: 50, y: 92, label: "ST"  },
  ],
  "3-5-2": [
    { id: "GK",  x: 50, y: 4,  label: "GK"  },
    { id: "RCB", x: 75, y: 33, label: "CB"  },
    { id: "CB", x: 50, y: 31, label: "CB"  },
    { id: "LCB", x: 25, y: 33, label: "CB"  },
    { id: "RWB", x: 88, y: 47, label: "RWB" },
    { id: "RCM", x: 78, y: 58, label: "CM"  },
    { id: "CM",  x: 50, y: 54, label: "CM"  },
    { id: "LCM", x: 22, y: 58, label: "CM"  },
    { id: "LWB", x: 12, y: 47, label: "LWB" },
    { id: "RST", x: 64, y: 88, label: "ST"  },
    { id: "LST", x: 36, y: 88, label: "ST"  },
  ],
  "3-4-3": [
    { id: "GK",  x: 50, y: 4,  label: "GK" },
    { id: "RCB", x: 70, y: 33, label: "CB" },
    { id: "CB", x: 50, y: 31, label: "CB" },
    { id: "LCB", x: 30, y: 33, label: "CB" },
    { id: "RM",  x: 88, y: 58, label: "RM" },
    { id: "RCM", x: 63, y: 56, label: "CM" },
    { id: "LCM", x: 37, y: 56, label: "CM" },
    { id: "LM",  x: 12, y: 58, label: "LM" },
  ...
  "3-4-2-1": [
    ...
    { id: "LCB", x: 25, y: 33, label: "CB"  },
    { id: "RM",  x: 88, y: 58, label: "RM"  },
    { id: "RCM", x: 68, y: 56, label: "CM"  },
    { id: "LCM", x: 32, y: 56, label: "CM"  },
    { id: "LM",  x: 12, y: 58, label: "LM"  },
    { id: "RAM", x: 78, y: 81, label: "RAM" },
    { id: "LAM", x: 22, y: 81, label: "LAM" },
    { id: "ST",  x: 50, y: 92, label: "ST"  },
  ],
  "3-4-1-2": [
    { id: "GK",  x: 50, y: 4,  label: "GK"  },
    ...
    { id: "CB",  x: 50, y: 31, label: "CB"  },
    { id: "LCB", x: 30, y: 33, label: "CB"  },
    { id: "RWB", x: 88, y: 53, label: "RWB" },
    { id: "RCM", x: 64, y: 58, label: "CM"  },
    { id: "LCM", x: 36, y: 58, label: "CM"  },
    { id: "LWB", x: 12, y: 53, label: "LWB" },
    { id: "CAM", x: 50, y: 74, label: "CAM" },
    { id: "RST", x: 64, y: 90, label: "ST"  },
    { id: "LST", x: 36, y: 90, label: "ST"  },
  ],
